...
class FoodDetail extends StatelessWidget {
  const FoodDetail({required this.product, super.key});
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 8.h,),
                        Text('Rp. ${product.price?.toInt() ?? '0'}',style: GoogleFonts.poppins(
                            fontSize: 16.sp,
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                product.description ?? '',
                style: GoogleFonts.poppins(
                    fontSize: 14.sp, color: CartLogicColor.hintColor),
              ),
              SizedBox(
                height: 12.h,
              ),
